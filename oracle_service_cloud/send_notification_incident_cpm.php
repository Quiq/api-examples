...
class sendNotificationIncident implements RNCPM\ObjectEventHandler {
    ...
    public static function apply($run_mode, $action, $inc, $n_cycles) {
        ...
        foreach ($contact->Phones as $phoneStruct) {
            $key = '26534b34-ee56-4549-ab5c-79c4aa0862c5'; //TODO - replace with your own values
            $secret = 'eyJhbGciOiJIUzI1NiIsImtpZCI6ImJhc2ljOjAifQ.eyJ0ZW5hbnQiOiJvc2M0LWRlbW8iLCJzdWIiOiIxMzkifQ.fZh1qx3x8Vk0ijrsWKg-0iZDPQH769eIXm2TSsWvwjo'; //TODO - replace with your own values
            $tenantBaseUrl = 'https://osc4-demo.goquiq.com'; // TODO - replace with your own values    
   
            $contactPhoneNumber = $phoneStruct->Number;
            $contactPoint = 'main';
            $topic = 'default';
            $messageText = 'Example outbound notification';
